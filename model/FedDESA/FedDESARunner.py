...
class FedDESA:
    ...
    def run(self, repeat):
        ...
        image_real, _ = self.train_dataset[0].__getitem__(0)
        image_syn,_ = mixup_train_set.__getitem__(0)
        # print('Real image size:', image_real.size(), 'Syn image size:', image_syn.size())
        ...
        for client_idx in range(len(self.n_clients)):
            print('Client:', client_idx, len(concated_train_sets[client_idx]), len(self.train_dataset[client_idx]))
